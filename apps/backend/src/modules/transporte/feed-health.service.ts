 ...
 *
 * Los tres feeds no son la API de una empresa grande: son
 * `ip.codesa.com.uy` y `microltda.ddns.net:32495`, DNS dinámico sobre la
 * conexión de la oficina de una empresa de ómnibus. Eso se cae. Un router que
 * se reinicia, una IP que cambia, un cable.
 *
