...
const DEFAULT_FEEDS: FeedSource[] = [
  ...
  // Maldonado Turismo y Micro son del mismo grupo y comparten servidor AVL:
  // una instancia por empresa, en puertos consecutivos. La URL de Micro sale
  // de su propia página de seguimiento, gpsmicro.maldonadoturismo.com/gps/.
  { operator: 'micro', url: 'http://microltda.ddns.net:32496/pub/avl.xml' },
];
